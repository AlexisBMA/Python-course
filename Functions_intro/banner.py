# When giving a value to a parameter it will be the default value.
# This means if we don't pass any value it will take the default.
...
banner_text("And that's to laugh, smile, dance and sing,", 60)
# We can only pass the argument we want like this
